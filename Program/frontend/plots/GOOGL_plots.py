...
# Config
name_company = f'Alphabet Inc Class A (GOOGL)'

# Импорт данных
file_path_3_day = 'ML-SD2023\\Program\\frontend\\data_predictions\\GOOGL_3_day.csv'
file_path_7_day = 'ML-SD2023\\Program\\frontend\\data_predictions\\GOOGL_7_day.csv'
file_path_14_day = 'ML-SD2023\\Program\\frontend\\data_predictions\\GOOGL_14_day.csv'
file_path_31_day = 'ML-SD2023\\Program\\frontend\\data_predictions\\GOOGL_31_day.csv'
