...
# Config
name_company = f'Amazon.com Inc (AMZN)'

# Импорт данных
file_path_3_day = 'ML-SD2023\\Program\\frontend\\data_predictions\\AMZN_3_day.csv'
file_path_7_day = 'ML-SD2023\\Program\\frontend\\data_predictions\\AMZN_7_day.csv'
file_path_14_day = 'ML-SD2023\\Program\\frontend\\data_predictions\\AMZN_14_day.csv'
file_path_31_day = 'ML-SD2023\\Program\\frontend\\data_predictions\\AMZN_31_day.csv'
